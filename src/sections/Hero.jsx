...
const Hero = () => {
  return (
    <section
      ...
      bg-gradient-to-br from-sky-900 via-indigo-900 to-slate-900
      dark:from-gray-900 dark:via-slate-900 dark:to-black text-white"
    >
      ...
      <motion.div
        ...
        rounded-3xl p-6 sm:p-8 md:p-12 shadow-2xl"
      >
        <motion.p
          initial={{ opacity: 0, x: -50 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ delay: 0.2 }}
          className="text-lg text-slate-200 dark:text-slate-400 mb-2"
        >
          👋 Hellooo, I'm
        </motion.p>
        ...
        <motion.h1
          ...
          bg-gradient-to-r from-blue-400 via-teal-400 to-cyan-300
        ...
        <motion.h2
          ...
          className="text-xl md:text-2xl font-semibold text-white dark:text-slate-200 mb-4"
        >
        ...
        <motion.p
          ...
          className="text-slate-300 dark:text-slate-400 text-sm md:text-base mb-6"
        >
        ...
        >
          <a
            href="/prasanth.pdf"
            download
            className="bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-cyan-500 hover:to-teal-500
          ...
          <a
            href="#contact"
            className="border border-white hover:bg-white hover:text-indigo-600
        ...
        >
          <a
            ...
            className="text-sky-300 hover:text-white text-xl transition duration-300"
          >
            <FaGithub />
          </a>
          <a
